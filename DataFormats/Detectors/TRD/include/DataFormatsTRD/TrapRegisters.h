...
class TrapRegisters
{
 public:
  ...
  enum TrapReg {
    ...
    kNP2, kNP3, kC08CPU0, kC09CPU0 /* will be q2 pid window settings, and partial version info.*/,
    kC10CPU0, kC11CPU0, kC12CPUA, kC13CPUA, kC14CPUA, kC15CPUA, kC08CPU1, kC09CPU1 /* version of trap code.*/,
    kC10CPU1, kC11CPU1, kC08CPU2, kC09CPU2 /* ndrift */, kC10CPU2, kC11CPU2, kC08CPU3, kC09CPU3/*Ycorrection*/,
 ...
 public:
  ...
  TrapRegInfo& operator[](uint32_t); ///! simply the access via an overloaded operator to the registers.
