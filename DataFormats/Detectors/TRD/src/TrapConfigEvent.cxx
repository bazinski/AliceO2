...
uint32_t TrapConfigEvent::getRegisterValue(const uint32_t regidx, const int mcmidx)
{
  ...
  uint32_t data = mConfigData[mConfigDataIndex[mcmidx]].getRegister(regidx, mTrapRegisters[regidx].getBase(),mTrapRegisters[regidx].getWordNumber(),mTrapRegisters[regidx].getShift(),mTrapRegisters[regidx].getMask());
