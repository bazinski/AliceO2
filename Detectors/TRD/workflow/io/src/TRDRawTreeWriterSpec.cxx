...
#include "TRDWorkflowIO/TRDRawTreeWriterSpec.h"
...
o2::framework::DataProcessorSpec getTRDRawTreeWriterSpec(bool mctruth, bool writeTrigRec)
{
  ...
  return MakeRootTreeWriterSpec("TRDRawTreeWriter",
                                "trddigits.root",
                                "o2sim",
