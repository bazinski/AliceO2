...
class CruRawReader
{
 public:
  ...
  // compare the half chambers seen in the config events vs those seen in the tracklet data.
  void compareConfigToTrackletsHCID() { mTrapConfigParser.compareToTrackletsHCID(mTrackletsHCID); };
 ...
 private:
  ...
  TrapConfigParser mTrapConfigParser;
