...
{
 public:
  DataReaderTask(bool compresseddata, bool byteswap, bool verbose, o2::header::DataDescription datadesc, bool headerverbose, bool dataverbose) : mCompressedData(compresseddata), mByteSwap(byteswap), mVerbose(verbose), mDataDesc(datadesc), mHeaderVerbose(headerverbose), mDataVerbose(dataverbose) {}
 ...
 private:
  ...
  o2::header::DataDescription mDataDesc; // input spec of th raw incoming data
};
